...
const recipes = [
    ...
    },
    {
        ...
        time: 15,
        difficulty: "easy",
        description: "Fresh vegetables, feta cheese, and olive tossed in olive oil and herbs.",
        category: "salad"
    },
    {
        id: 5,
    ...
    },
    {
        ...
        time: 30,
        difficulty: "medium",
        description: "Thai stir-fried noodles with shrimp, peanuts, and tangy tamarind sauce.",
        category: "noodles"
    },
 {
        id: 8,
...
console.log(recipeContainer); // Check if the container is selected correctly
...
console.log(createRecipeCard(recipes[0]));
 // Check the generated HTML for the first recipe
